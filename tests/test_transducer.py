...
from transientbvd import predefined_transducer, predefined_transducers, Transducer, load_transducers


class TestTransducerModule(unittest.TestCase):
    @patch("transientbvd.transducer._measured_transducers", {
        "SMBLTD45F40H_1": Transducer(
            name="SMBLTD45F40H_1", rs=21.05, ls=35.15e-3, cs=448.62e-12, c0=4075.69e-12,
            manufacturer="STEINER & MARTINS INC., Davenport, USA"
        ),
        "GB-4540-4SH": Transducer(
            name="GB-4540-4SH", rs=17.2, ls=32.52e-3, cs=464.1e-12, c0=3.397e-9,
            manufacturer="Granbo Ultrasonic, Shenzhen, China"
        )
    })
    ...
    def test_predefined_transducer_valid(self):
        ...
        transducer = predefined_transducer("SMBLTD45F40H_1")
